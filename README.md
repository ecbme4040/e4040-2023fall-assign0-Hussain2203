[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/PBR_CeaE)
# Assignment 0

## Distributed in Github Repository e4040-2023fall-assign0
...
3. The solution to the assignment has to be pushed into the same repository
...
* Students need to use the following name for the repository with their solutions: `e4040-2023fall-assign0-UNI` (the first part "e4040-2023fall-assign0" will be inherited from the assignment repository, so only UNI needs to be changed) 
* Initially, the system may give the repository a name which ends with a student's Github user ID. The student should change that name and replace it with the name requested in the point above
  * Good Example: `e4040-2023fall-assign0-zz9999`
  * Bad example: `e4040-2023fall-assign0-e4040-2023fall-assign0-zz9999`
